...
public class PanelAdmin extends JFrame {
    ...
    private void initializeComponents() {
        ...
        titulo = new JLabel("PANEL DEL ADMINISTRADOR");

        boton1 = new JButton("Crear nueva vacante");
        boton2 = new JButton("Consultar vacantes");
        boton3 = new JButton("Postulaciones");
    ...
    private void addActionListeners() {
        ...
        boton2.addActionListener(e ->{
            new VacantesPublicadas().setVisible(true);
            this.setVisible(false);
        });

        boton3.addActionListener(e->{
            new Postulaciones().setVisible(true);
            this.setVisible(false);
        });
